...
DATABASES = {
    'default': {
        ...
        'NAME': 'webpr_production',
        'USER': 'webpr_production',
        'PASSWORD': 'jdjFHisurjSofPSfsaD',
        'HOST': 'rds-production.aws.io',
        'PORT': '5432',
    }
}

# Celery url
BROKER_URL = 'redis://redis.aws.io:6379/0'
CELERY_REDIS_HOST = 'redis.aws.io'
CELERY_RESULT_BACKEND = 'redis://redis.aws.io:6379/0'
...
# RAVEN_CONFIG = {
#     'dsn': 'https://860a3a64ca414aa8be79ad03dca287e1:28efd1b9e2794ac59929df420032e306@sentry.saritasa.com/8',
# }
...
AWS_STORAGE_BUCKET_NAME = 'webpr-production'
...
SEMANTRIA_CONF_ID = 'c5c7217760ddbdb7507e75af5bfb7743'
